...
const info = [
  ...
  { icon: <FaEnvelope />, title: "Email", description: "dhruv621999goyal@gmail.com" },
  { icon: <FaMapMarkerAlt />, title: "Address", description: "Lucknow, UP, India." },
];
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="ui-ux-design">Programming</SelectItem>
                    <SelectItem value="logo-design">AI/ML</SelectItem>
                    <SelectItem value="logo-design">UI/UX Design</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
